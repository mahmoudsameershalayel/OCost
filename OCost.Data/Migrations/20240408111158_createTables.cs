    ...
    public partial class createTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestSuppliers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestSuppliers_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestSuppliers_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountDue = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responses_RequestLines_RequestLineId",
                        column: x => x.RequestLineId,
                        principalTable: "RequestLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responses_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "ConcurrencyStamp", "Created_At", "PasswordHash", "PostCode", "SecurityStamp", "Updated_at" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestSuppliers_RequestId",
                table: "RequestSuppliers",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestSuppliers_SupplierId",
                table: "RequestSuppliers",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Responses_RequestLineId",
                table: "Responses",
                column: "RequestLineId");

            migrationBuilder.CreateIndex(
                name: "IX_Responses_SupplierId",
                table: "Responses",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemAdministrators_ApplicationUserId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "c69f18b2-7aee-4ae3-b352-3f49aa282630", new DateTime(2024, 4, 6, 13, 3, 14, 302, DateTimeKind.Local).AddTicks(787), "AQAAAAIAAYagAAAAEA1yzj89FBnaDCRmfjer232a4Bw+Qw7Ck4Zy5RqkaMULOY73g2lMpM8dFY1a8ljNKA==", "8daef16e-0419-46c2-b322-8699c9bc4338", new DateTime(2024, 4, 6, 13, 3, 14, 302, DateTimeKind.Local).AddTicks(850) });
        }
    }
}
